...
public class RecordPrimitiveTypes {
    ...
    public boolean fBoolean = true;    
    public char fCharacter = 'c';
    public byte fByte = 1;
    public short fShort = 2;
    public int fInteger = 3;
    public long fLong = 4;
    public float fFloat = 5.5f;
    public double fDouble = 6.6d;
    public String fString = "string";
    public RetentionPolicy fEnum = RetentionPolicy.SOURCE; 
    
    public static RecordPrimitiveTypes empty() {
